    ...
    <>
      ...
      <div className="modal" id="settings-modal">
        <div className="mbox">
          ...
          <div className="row"><label>Study mode (Flashcard = cards with image & audio · Voice = mic answers)</label><select id="s-mode"><option value="silent">Flashcard</option><option value="voice">Voice</option></select></div>
